...
export const assessmentConfig: ResourceConfig<AssessmentQuestion> = {
  ...
  fields: [
    ...
    { key: 'totalSteps', label: 'Нийт алхам', type: 'number' },
    {
      ...
      itemFields: [
        { key: 'key', label: 'Key', type: 'text', placeholder: 'a', required: true },
  ...
  return {
    ...
    fields: [
      ...
      { key: 'tags', label: 'Tag-ууд', type: 'string-list', placeholder: 'Tag...', hint: 'Tag нэмэх' },
      {
        ...
        addLabel: 'Эмч нэмэх',
        itemFields: [
          { key: 'id', label: 'ID', type: 'text', placeholder: 'd1', required: true },
          { key: 'name', label: 'Нэр', type: 'text', required: true },
          { key: 'specialty', label: 'Мэргэжил', type: 'text', required: true },
          { key: 'experienceYears', label: 'Туршлага (жил)', type: 'number' },
          { key: 'bio', label: 'Танилцуулга', type: 'textarea' },
        ],
      },
      {
        key: 'services',
        label: 'Үйлчилгээ',
        type: 'object-list',
        addLabel: 'Үйлчилгээ нэмэх',
        itemFields: [
          { key: 'id', label: 'ID', type: 'text', placeholder: 's1', required: true },
          { key: 'name', label: 'Нэр', type: 'text', required: true },
          { key: 'priceMnt', label: 'Үнэ (₮)', type: 'number', required: true },
          { key: 'category', label: 'Ангилал', type: 'text', placeholder: 'Зөвлөгөө' },
          {
            key: 'doctorId',
            label: 'Эмч',
            type: 'select',
            optionsFromField: 'doctors',
            optionsFromFieldValueKey: 'id',
            optionsFromFieldLabelKey: 'name',
...
export const promoCodeConfig: ResourceConfig<PromoCode> = {
  ...
  fields: [
    ...
    { key: 'discountPercent', label: 'Хөнгөлөлт (%)', type: 'number', required: true },
    {
      ...
      hint: 'Хоосон бол бүх багцад хамаарна',
    },
